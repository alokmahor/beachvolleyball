...
public class controls extends Frame implements KeyListener, ActionListener
...
public controls(PrintWriter pw) {
...
public void runningfunction(controls fra,String playername){
 ...
 * */
///HERE SHOULD CHOOSE WHICH BACK TO PAINT.
if(bl.xposball>=650){
