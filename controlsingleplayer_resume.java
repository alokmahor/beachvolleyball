...
public class controlsingleplayer_resume extends Frame implements KeyListener, ActionListener
...
public controlsingleplayer_resume(int player) {
...
public void runningfunction(controlsingleplayer_resume fra,String playername,double blx, double bly, double blvx, double blvy, double u1x, double u1y, int u1p,
double u2x, double u2y, int u2p,double reach,double jump,int d,int j,int flagc)
throws IOException
{
...
bl.xposball =blx;bl.yposball =bly;bl.xvelball= blvx; bl.yvelball =blvy ;
         ...
         comp.xposcomp=u2x;comp.yposcomp = u2y; comp.xvelcomp=0;comp.yvelcomp=0;comp.point=u2p;comp.d=d;comp.j=j;comp.flag=flagc;comp.reach=reach;comp.jump=jump;
